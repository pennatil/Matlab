...
if movement(i-1,j)==2
    ...
    elseif (B(j,1)+1==10 && B(j,2)==74)
        ...
        %if the next empty space is in [5,4], probability of turning west
        %or keep going south
    elseif (B(j,1)+1==11 && B(j,2)==74)
        A(B(j,1)+1,B(j,2))=B(j,3);
        A(B(j,1),B(j,2))=4;
        B(j,1)=B(j,1)+1;
        movement(i,j)=2;
        %if the next empty space is in [6,4], go south
    elseif (B(j,1)+1==12 && B(j,2)==74)
        A(B(j,1)+1,B(j,2))=B(j,3);
        A(B(j,1),B(j,2))=4;
        B(j,1)=B(j,1)+1;
        movement(i,j)=2;
...
elseif movement(i-1,j)==6
    if (B(j,1)==12 && B(j,2)+1==72)
        A(B(j,1),B(j,2)+1)=B(j,3);
        A(B(j,1),B(j,2))=1;
        B(j,2)=B(j,2)+1;
        movement(i,j)=6;
    elseif (B(j,1)==12 && B(j,2)+1==73)
        A(B(j,1),B(j,2)+1)=B(j,3);
        A(B(j,1),B(j,2))=4;
        B(j,2)=B(j,2)+1;
        movement(i,j)=6;
    elseif (B(j,1)==12 && B(j,2)+1==74)
        A(B(j,1),B(j,2)+1)=B(j,3);
        A(B(j,1),B(j,2))=4;
        B(j,2)=B(j,2)+1;
        movement(i,j)=6;
    ...
    elseif (B(j,1)==14 && B(j,2)+1==74)
        A(B(j,1),B(j,2)+1)=B(j,3);
        A(B(j,1),B(j,2))=4;
        B(j,2)=B(j,2)+1;
        movement(i,j)=6;
    elseif (B(j,1)==14 && B(j,2)+1==75)
        A(B(j,1)+1,B(j,2))=B(j,3);
        A(B(j,1),B(j,2))=4;
        B(j,1)=B(j,1)+1;
        movement(i,j)=2;
