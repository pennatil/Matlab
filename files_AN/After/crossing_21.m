...
if movement(i-1,j)==2
    ...
    elseif (B(j,1)+1==163 && B(j,2)==77)
        ...
        B(j,1)=B(j,1)+1;
        movement(i,j)=2;
    elseif (B(j,1)+1==164 && B(j,2)==77)
        A(B(j,1)+1,B(j,2))=B(j,3);
        A(B(j,1),B(j,2))=21;
        B(j,1)=B(j,1)+1;
        movement(i,j)=2;
    elseif (B(j,1)+1==165 && B(j,2)==77)
        A(B(j,1),B(j,2)+1)=B(j,3);
        A(B(j,1),B(j,2))=21;
        B(j,2)=B(j,2)+1;
        movement(i,j)=6;
