...
chassi_y = [0 h/2 h/2 0];

wheel_1_x=[2*w/5 2*w/5 (w/10) (w/10)];
wheel_1_y=[0 -h/20 -h/20 0];

wheel_2_x=[-(2*w/5) -(2*w/5) -(w/10) -(w/10)];
wheel_2_y=[0 -h/20 -h/20 0];

wheel_3_x=[-(2*w/5) -(2*w/5) -(w/10) -(w/10)];
wheel_3_y=[h/2 (11*h/20) (11*h/20) h/2];

wheel_4_x=[2*w/5 2*w/5 (w/10) (w/10)];
wheel_4_y=[h/2 (11*h/20) (11*h/20) h/2];

window_1_x=[-w/6 -w/6 w/12 w/12];
window_1_y=[h/12 (5*h)/12  3*(15*h)/120 (15*h)/120];

window_2_x=[w/12 w/12 w/12+w/6 w/12+w/6];
window_2_y=[3*(15*h)/120 (15*h)/120 (15*h)/120 3*(15*h)/120];

window_3_x=[w/12+w/6 w/12+w/6 5*w/12 5*w/12];
window_3_y=[(15*h)/120 3*(15*h)/120 (5*h)/12 h/12];

window_4_x=[-w/6 5*w/12 w/12+w/6 w/12];
window_4_y=[(5*h)/12 (5*h)/12 (3*(15*h)/120)+h/100 (3*(15*h)/120)+h/100];

window_5_x=[-w/6 5*w/12 w/12+w/6 w/12];
window_5_y=[h/12 h/12 ((15*h)/120)-h/100 ((15*h)/120)-h/100];
